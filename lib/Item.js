...
var XPath = require('xpath'),
    ...
    MultimediaAddition = require('./MultimediaItemAddition');
...
module.exports = class {
    ...
    additionalContent () {
        ...
        // do we have enclosure 
        XPath.select(".//enclosure", this[_node]).forEach(function(node) {
            additionals.push(new MultimediaAddition(node));
        });
